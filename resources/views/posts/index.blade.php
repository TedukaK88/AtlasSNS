            ...
            <tr>
                <div class="post-table">
                  ...
                  <div class="">
                    ...
                    <td><div class="icon-bg delete-icon-bg"><a href="/top/{{$post->id}}/delete" onclick="return confirm('この投稿を削除してよろしいですか？')"><img class="post-icon delete-icon" src="images/trash.png"></a></div></td>
                  </div>
                  @endif
                </div>
            </tr>
